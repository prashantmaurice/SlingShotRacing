...
public class RestartScreen implements Screen {
	...
	SlingShotRaceGame game; // Note it's "GyroGame" not "Game"
    ...
    // constructor to keep a reference to the main Game class
     public RestartScreen(SlingShotRaceGame dashGame){
            this.game = dashGame;
     ...
     public void render(float delta) {
    	 ...
    	 //yourScore=game.getYourScore();
          ...
          font.setScale((float) 1);
          font.draw(batch, "CONGOS YOU R A STUDD ", 10, screenHeight/2+80);//text display
